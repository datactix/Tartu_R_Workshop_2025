...
-   **Recipe 1a: Reading CSV Files**
    ...
    ```{r}
    readr::read_csv(file = here::here("data/wrangling_files/synthetic_data_2024-11-24.csv"), 
...
-   **Recipe 1b: Reading TSV Files**
    ...
    ```{r}
    readr::read_tsv(file=here::here("data/wrangling_files/synthetic_data_2024-11-24.tsv"), 
                    # consider the first row as column names
                    col_names = TRUE, 
                    # ability to skip the N first rows if needed
                    skip = 0,
...
-   **Recipe 1c: Importing Excel Files**
    ...
    ```{r}
    readxl::read_excel(path = here::here("data/wrangling_files/synthetic_data_2024-11-24.xlsx"), 
